...
def generate_launch_description():
    ...
    world_file = os.path.join(get_package_share_directory("p3at_description"), "world", "test.sdf")
    ...
    slam_toolbox = Node( 
        ...
        parameters=[
                get_package_share_directory('p3at_description') + '/mapper_params_online_async.yaml'
        ], 
        output='screen',
    )
